...
<body>
    ...
    <div class="row m-auto mt-3" style="max-width: 60%;">
        <div class="col-md-12">
            <div class="card mb-4">
                <br>
                <h4 class="card-header m-auto" style="color: red; font-weight: 600; font-size: 20px;"> <i class="fa-solid fa-building" style="color: green; margin: auto; width: 85px; display: flex; justify-content: center;"></i><br>Renseigner les informations du nouveau Centre d'enrôlement</h4>
                <!-- Account -->
                <div class="card-body pt-2">
                    <form id="addCEForm" style="max-width: 80%;" class="p-4" method="POST" action="{{ route('ce.store') }}">
                        @csrf
                        <div class="row mt-2 gy-4">
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control" id="nom" name="nom" placeholder="Nom du CE" />
                                    <label style="font-weight: 600; font-size: 13.5px; color: green;" for="nom">Nom du CE</label>
                                    @error('nom')
                                    <span>{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input type="tel" class="form-control" id="tel1" name="tel1" placeholder="Téléphone du CE" />
                                    <label style="font-weight: 600; font-size: 13.5px; color: green;" for="tel1">Telephone du CE</label>
                                    @error('tel1')
                                    <span>{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control" id="adresse" name="adresse" placeholder="Adresse du CE" />
