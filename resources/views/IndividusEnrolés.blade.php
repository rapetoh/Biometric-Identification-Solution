                ...
                <table class="table table-striped">
                    ...
                    <tbody class="table-border-bottom-0">
                            ...
                            <div class="modal-dialog modal-lg" role="document"> <!-- modal-lg pour un grand modal -->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h6 class="modal-title" style="font-size: 15px; font-weight: 600"><i style="color: green;" class="fa-solid fa-folder ms-4 me-2">&nbsp;&nbsp;</i> Dossier -- {{$dossier->NIU}} </h6>
                                    ...
                                    <div class="modal-body">
                                        <div class="container">
                                            ...
                                            <div class="column">
                                                <br><br>
                                                <p style="font-size: 12px;"><span style="font-weight:500;color:green">Nom:</span> {{ $dossier->donneesDemographiques->nom ? $dossier->donneesDemographiques->nom : 'N/A' }}</p>
                                                <br><p style="font-size: 12px;"><span style="font-weight:500;color:green">Prénom:</span> {{ $dossier->donneesDemographiques->prenom ? $dossier->donneesDemographiques->prenom : 'N/A' }}</p>
                                                <br><p style="font-size: 12px;"><span style="font-weight:500;color:green">Sexe:</span> {{ $dossier->donneesDemographiques->sexe ? $dossier->donneesDemographiques->sexe : 'N/A' }}</p>
                                                <br><p style="font-size: 12px;"><span style="font-weight:500;color:green">Nom de jeune fille:</span> {{ $dossier->donneesDemographiques->nom_de_jeune_fille ? $dossier->donneesDemographiques->nom_de_jeune_fille : 'N/A' }}</p>
                                                <br><p style="font-size: 12px;"><span style="font-weight:500;color:green">Date de naissance:</span> {{ $dossier->donneesDemographiques->DOB ? $dossier->donneesDemographiques->DOB : 'N/A' }}</p>
                                                <br><p style="font-size: 12px;"><span style="font-weight:500;color:green">Pays-ville de naissance:</span> {{ $dossier->donneesDemographiques->pays_ville_naissance ? $dossier->donneesDemographiques->pays_ville_naissance : 'N/A' }}</p>
                                                <br><p style="font-size: 12px;"><span style="font-weight:500;color:green">Pays-ville de résidence:</span> {{ $dossier->donneesDemographiques->pays_ville_residence ? $dossier->donneesDemographiques->pays_ville_residence : 'N/A' }}</p>
                                                <br><p style="font-size: 12px;"><span style="font-weight:500;color:green">Quartier de résidence:</span> {{ $dossier->donneesDemographiques->DOB ? $dossier->donneesDemographiques->DOB : 'N/A' }}</p>
                                                <br><p style="font-size: 12px;"><span style="font-weight:500;color:green">Profession:</span> {{ $dossier->donneesDemographiques->profession ? $dossier->donneesDemographiques->profession : 'N/A' }}</p>
                                                <br><p style="font-size: 12px;"><span style="font-weight:500;color:green">Secteur d'activité:</span> {{ $dossier->donneesDemographiques->secteur_emploi ? $dossier->donneesDemographiques->secteur_emploi : 'N/A' }}</p>
                                                <br><p style="font-size: 12px;"><span style="font-weight:500;color:green">Statut Matrimonial:</span> {{ $dossier->donneesDemographiques->statut_matrimonial ? $dossier->donneesDemographiques->statut_matrimonial : 'N/A' }}</p>
                                                <br><p style="font-size: 12px;"><span style="font-weight:500;color:green">1er Contact:</span> {{ $dossier->donneesDemographiques->tel1 ? $dossier->donneesDemographiques->tel1 : 'N/A' }}</p>
                                                <br><p style="font-size: 12px;"><span style="font-weight:500;color:green">2e Contact:</span> {{ $dossier->donneesDemographiques->tel2 ? $dossier->donneesDemographiques->tel2 : 'N/A' }}</p>
                                                <br><p style="font-size: 12px;"><span style="font-weight:500;color:green">Mail:</span> {{ $dossier->donneesDemographiques->mail ? $dossier->donneesDemographiques->mail : 'N/A' }}</p>
                                                <br><p style="font-size: 12px;"><span style="font-weight:500;color:green">Pièces Justificatives fournies:</span> {{ $dossier->donneesDemographiques->pieces_justificatives ? $dossier->donneesDemographiques->pieces_justificatives : 'N/A' }}</p>
                                                <br><p style="font-size: 12px;"><span style="font-weight:500;color:green">Groupe sanguin:</span> {{ $dossier->donneesDemographiques->groupe_sanguin ? $dossier->donneesDemographiques->groupe_sanguin : 'N/A' }}</p>
                                                <br><p style="font-size: 12px;"><span style="font-weight:500;color:green">Nom de la 1ère personne à prévenir:</span> {{ $dossier->donneesDemographiques->nom_personne_a_prevenir1 ? $dossier->donneesDemographiques->nom_personne_a_prevenir1 : 'N/A' }}</p>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ $dossier->donneesDemographiques->tel1 ? \Carbon\Carbon::parse($dossier->donneesDemographiques->DOB)->age : 'Non spécifiée' }}
                            </td>
                            <td>
                                {{ $dossier->donneesDemographiques->tel1 ? $dossier->donneesDemographiques->profession : 'Non spécifiée' }}
                            </td>
                            <td>
                                {{ $dossier->donneesDemographiques->tel1 ? $dossier->donneesDemographiques->quartier_residence : 'Non spécifiée' }}
                            </td>
                            <td>
                                <span class="badge rounded-pill bg-label-danger me-1">{{ $dossier->donneesDemographiques->tel1 ? $dossier->donneesDemographiques->tel1 : 'Non spécifiée' }}</span>
                            </td>
                            ...
                            <td>
                                <div class="dropdown">
                                    <button type="button" class="btn m-auto dropdown-toggle hide-arrow mydropitem" data-toggle="modal" data-target="#largeModal{{$dossier->NIU}}"><i class="fa-solid fa-eye" style="color:green" data-param1="{{$dossier->NIU}}" data-param2="{{$dossier->donneesDemographiques->prenom}}"></i></button>
