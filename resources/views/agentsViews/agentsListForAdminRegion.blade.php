                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                            <td>
                                ...
                                <span class="fw-medium" style="font-weight: bold">{{ $agent->nom ? $agent->nom : 'Non spécifiée' }}</span>
                            </td>
                            <td>
                                {{ $agent->prenom ? $agent->prenom : 'Non spécifiée' }}
                            </td>
                            <td>
                                {{ $agent->telephone ? $agent->telephone : 'Non spécifiée' }}
                            </td>
                            <td>
                                {{ $agent->mail ? $agent->mail : 'Non spécifiée' }}
                            </td>
                            <td>
                                @if($agent->isAdmin == 1)
                            ...
                            <td>
                                {{ $agent->centreEnrolement ? $agent->centreEnrolement->nom : 'Non spécifiée' }}
                            </td>
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item start-0" href="{{ route('agents.edit', $agent->idAgent) }}"> <i style="color: green;" class="fa-solid fa-pencil me-2"></i>&nbsp;Modifier</a>
                                        <form action="{{ route('agents.destroy', $agent->idAgent) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button class="dropdown-item text-danger" type="submit" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet agent ?');"><i style="color: red;" class="fa-solid fa-trash me-2"></i> Suppprimer</a></button>
                                        </form>
