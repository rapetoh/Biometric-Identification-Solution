...
<body>
    ...
    <div class="row m-auto mt-3" style="max-width: 60%;">
        <div class="col-md-12">
            <div class="card mb-4">
                <br>
                <h4 class="card-header m-auto" style="color: red; font-weight: 600; font-size: 20px;"> <img style="margin: auto;" src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template-free/demo/assets/img/avatars/7.png" alt class="w-px-40 h-auto rounded-circle"><br>Modifier les informations de l'Agent <span style="color:forestgreen; text-transform: uppercase;">{{ $agent->nom }}  {{ $agent->prenom }}</span></h4>
                <!-- Account -->
                <div class="card-body pt-2">
                    <form id="formAccountSettings" style="max-width: 80%;" class="p-4" method="POST" action="{{ route('agents.update', $agent->idAgent) }}">
                        @csrf
                        @method('PUT')
