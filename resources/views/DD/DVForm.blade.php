                        ...
                        <div class="container">
                            ...
                            <div class="column">
                                ...
                                <form id="dvForm" enctype="multipart/form-data" style="max-width: 80%;" class="p-4" method="POST" action="{{route('dvForm.store')}}">
                                    ...
                                    <div class="mt-4">
                                        <button type="button" data-toggle="modal" data-target="#myModal" style="background-color: green;" class="btn btn-primary me-2">VALIDER LE DOSSIER</button>
                                    </div>
                                    <div class="modal fade" style="width: 100%;" data-backdrop="static" data-keyboard="false" id="myModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="container">
                                                                ...
                                                                <div class="card-inner">
                                                                    <div class="front">
                                                                        ...
                                                                        <div class="row card-no">
                                                                            <p style="margin: auto;">{{$item->donneesDemographiques->NIU}}</p>
                                                                        </div>
                                                                        <br>
                                                                        <br><br>
                                                                        <div style="display: inline-flex; justify-content: space-between; align-items: center;">
                                                                        <div style="margin-right: 55px;">
                                                                            <p style="font-size: 12px; ">TITULAIRE</p>
                                                                            <p style="font-size: 12px; width: 200px; font-weight: bold;">{{$item->donneesDemographiques->nom}} {{$item->donneesDemographiques->prenom}}</p>
                                                                        </div>
                                                                        <div>
                                                                            <p style="font-size: 12px;">REF_ENR</p>
                                                                            <p style="font-size: 12px; font-weight: bold;">{{$item->donneesDemographiques->ref_enrolement}}</p>
                                                                        </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="back">
                                                        ...
                                                        <div class="column">
                                                            Recicipe
                                                            <br><br>
                                                            <embed width="100%" height="85%" src="{{ route('pdf.generate',['iddemo'=>$item->donneesDemographiques->idDDemo]) }}" type="application/pdf">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" style="background-color: green;" class="btn btn-primary me-2">CLOTURER LE DOSSIER</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
