                ...
                <div class="card-body pt-2">
                    <div class="container-fluid mt-5">
                        ...
                        <div class="container mb-4">
                            <div class="card card-custom mx-2" style="border: green solid 1px; width:98%">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="card text-center mb-3 card-custom mx-2">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text" style="font-weight: 600"><span style="font-weight: 500; color: green;">NIU: </span> {{ $person->NIU }}</p>
                                                    <br>
                                                    ...
                                                    <br>
                                                    <p class="card-text"><span style="font-weight: 500; color: green;">Contact: </span> {{ $person->tel1?$person->tel1:'N/A' }} - {{ $person->tel2?$person->tel2:'N/A' }}</p>
                                                    <br>
                                                    <p class="card-text"> <span style="font-weight: 500; color: green;">Mail: </span>{{ $person->mail?$person->mail:'N/A' }}</p>
                                                    <br>
                                                    ...
                                                    <br>
                                                    <p class="card-text"> <span style="font-weight: 500; color: green;">Date d'enrôlement: </span>{{ $person->created_at }}</p>
                                                    <br>
                                                    <form action="{{route('DedoublonageDeletion', $person->ref_enrolement)}}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" style="background-color: red;" class="btn btn-primary" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce doublon ?');">Supprimer le doublon</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
