...
<head>
  ...
  <!-- laravel CRUD token -->
  <meta name="csrf-token" content="A5zCjTPhiUG4EvKKwRBLrp9dF0bwvJkeONn0mi0o">
  <!-- Canonical SEO -->
...
<link rel="stylesheet" href="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template-free/demo/assets/vendor/fonts/materialdesignicons.css?id=9a16ed1a5c9f397c4fb730e76fd36384" />
<link rel="stylesheet" href="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template-free/demo/assets/vendor/libs/node-waves/node-waves.css?id=aa72fb97dfa8e932ba88c8a3c04641bc" />
<!-- Core CSS -->
...
<!-- Vendors CSS -->
<link rel="stylesheet" href="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template-free/demo/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css?id=e542d5fe23051cba0a5aedb27dadd732" />
...
<!-- Page Styles -->
<!-- Page -->
<link rel="stylesheet" href="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template-free/demo/assets/vendor/css/pages/page-misc.css">

  <!-- Include Scripts for customizer, helper, analytics, config -->
  <!-- laravel style -->
<script src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template-free/demo/assets/vendor/js/helpers.js"></script>

<!--? Config:  Mandatory theme config file contain global vars & default theme options, Set your preferred theme option in this file.  -->
<script src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template-free/demo/assets/js/config.js"></script>
...
<div class="misc-wrapper">
  <h1 class="mb-2 mx-2" style="font-size: 6rem;">Oups !</h1>
  <h4 class="mb-2">Erreur serveur/base de données: votre requête n'a pas abouti.⚠️</h4>
  <p class="mb-4 mx-2">{{ $error }}</p>
  <div class="d-flex justify-content-center mt-5">
    <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template-free/demo/assets/img/illustrations/misc-mask-light.png" alt="misc-error" class="scaleX-n1-rtl misc-bg d-none d-lg-inline-block">
    <div class="d-flex flex-column align-items-center">
      <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template-free/demo/assets/img/illustrations/404.png" alt="misc-error" class="misc-model img-fluid z-1" width="580">
      <div>
        <a href="{{ route('home') }}" class="btn btn-danger text-center my-4">Acceuil</a>
      </div>
    </div>
  </div>
</div>
...
<!-- END: Page Vendor JS-->
<!-- BEGIN: Theme JS-->
<script src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template-free/demo/assets/js/main.js?id=4f816bbbc912e9a5bcff6119bc265966"></script>
