                ...
                <div class="forms-wrap">
                    ...
                    <form method="POST" action="{{route('Pre_Enrôlement.store')}}">
                        ...
                        <div class="actual-form" style="max-width: auto">
                            ...
                            <div class="input-wrap" id="nomJeuneFilleDiv" style="display: none;">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="toggleable form-control @error('nomJeuneFille') is-invalid @enderror" id="nomJeuneFille" name="nomJeuneFille" placeholder="Nom de jeune fille" />
                            ...
                            <div class="input-wrap">
                                <div class="form-floating form-floating-outline">
                                    <input type="date" class="toggleable form-control @error('dateNaissance') is-invalid @enderror" id="dateNaissance" name="dateNaissance" />
                            ...
                            <div class="input-wrap">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="toggleable form-control @error('paysVilleNaissance') is-invalid @enderror" id="paysVilleNaissance" name="paysVilleNaissance" placeholder="Pays/Ville de naissance" />
                            ...
                            <div class="input-wrap">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="toggleable form-control @error('paysVilleResidence') is-invalid @enderror" id="paysVilleResidence" name="paysVilleResidence" placeholder="Pays/Ville de résidence" />
                            ...
                            <div class="input-wrap">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="toggleable form-control @error('quartierResidence') is-invalid @enderror" id="quartierResidence" name="quartierResidence" placeholder="Quartier de résidence" />
                            ...
                            <div class="input-wrap" id="nomPrenomsConjointDiv" style="display: none;">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="toggleable form-control @error('nomPrenomsConjoint') is-invalid @enderror" id="nomPrenomsConjoint" name="nomPrenomsConjoint" placeholder="Nom & Prénoms du conjoint" />
                            ...
                            <div class="input-wrap">
                                <div class="form-floating form-floating-outline">
                                    <input type="tel" class="toggleable form-control @error('tel1') is-invalid @enderror" id="tel1" name="tel1" placeholder="Téléphone 1" />
                            ...
                            <div class="input-wrap">
                                <div class="form-floating form-floating-outline">
                                    <input type="tel" class="toggleable form-control @error('tel2') is-invalid @enderror" id="tel2" name="tel2" placeholder="Téléphone 2" />
                            ...
                            <div class="input-wrap">
                                <div class="form-floating form-floating-outline">
                                    <input type="email" class="toggleable form-control @error('mail') is-invalid @enderror" id="mail" name="mail" placeholder="Email" />
                            ...
                            <div class="input-wrap">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="toggleable form-control @error('nomPersonnePrevenir1') is-invalid @enderror" id="nomPersonnePrevenir1" name="nomPersonnePrevenir1" placeholder="Nom de la personne à prévenir 1" />
                            ...
                            <div class="input-wrap">
                                <div class="form-floating form-floating-outline">
                                    <input type="tel" class="toggleable form-control @error('numPersonnePrevenir1') is-invalid @enderror" id="numPersonnePrevenir1" name="numPersonnePrevenir1" placeholder="N° de la personne à prévenir 1 " />
                            ...
                            <div class="input-wrap">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="toggleable form-control @error('nomPersonnePrevenir2') is-invalid @enderror" id="nomPersonnePrevenir2" name="nomPersonnePrevenir2" placeholder="Nom de la personne à prévenir 2" />
                            ...
                            <div class="input-wrap">
                                <div class="form-floating form-floating-outline">
                                    <input type="tel" class="toggleable form-control @error('numPersonnePrevenir2') is-invalid @enderror" id="numPersonnePrevenir2" name="numPersonnePrevenir2" placeholder="N° de la personne à prévenir 2" />
                            ...
                            <div class="input-wrap">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="toggleable form-control @error('profession') is-invalid @enderror" id="profession" name="profession" placeholder="Profession" />
                            ...
                            <div class="input-wrap" id="autreSecteurDiv" style="display: none;">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="toggleable form-control @error('autreSecteur') is-invalid @enderror" id="autreSecteur" name="autreSecteur" placeholder="Précisez le secteur" />
                            ...
                            <button style="background-color: green;" type="submit" value="Sign In" class="sign-btn" onclick="return confirm('Vous allez soumettre vos données et recevoir un numéro de référence à présenter pour vous faire enrôler.\nContinuer ?');">Soumettre le formulaire de pré-enrôlement</button>
                            <!-- 
                <p class="text">
